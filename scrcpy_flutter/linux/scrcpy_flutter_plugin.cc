...
#include "scrcpy_flutter_plugin_private.h"
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  ScrcpyFlutterPlugin* plugin = SCRCPY_FLUTTER_PLUGIN(user_data);
  scrcpy_flutter_plugin_handle_method_call(plugin, method_call);
}
