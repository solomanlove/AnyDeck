...
const devicesControlZh = {
  ...
  'apps': '应用',
  'network': '网络',
  'deviceHttpProxy': '设备 HTTP 代理',
  'deviceProxyDesc':
      '设置当前 Android 设备的系统 HTTP proxy。代理地址默认使用当前电脑局域网 IP，成功应用后会作为所有设备共享的下次默认值。',
  'deviceProxyHost': '代理地址',
  'deviceProxyPort': '端口',
  'deviceProxyApply': '应用代理',
  'deviceProxyClear': '清除代理',
  'deviceProxyNotSet': '未设置代理',
  'deviceProxyLoading': '正在读取代理...',
  'deviceProxyReadFailed': '读取代理失败',
  'deviceProxyInvalid': '请输入有效的代理地址和 1-65535 端口',
  'deviceProxyApplySuccess': '代理设置成功',
  'deviceProxyApplyFailed': '代理设置失败',
  'deviceProxyClearSuccess': '代理已清除',
  'deviceProxyClearFailed': '清除代理失败',
  'portForwarding': '端口转发',
  'savedPresets': '保存的预设',
...
const devicesControlEn = {
  ...
  'deviceAndroidVersionCol': 'Android Version',
  ...
  'apps': 'Apps',
  'network': 'Network',
  'deviceHttpProxy': 'Device HTTP Proxy',
  'deviceProxyDesc':
      'Set the system HTTP proxy for the current Android device. The host defaults to this computer LAN IP and is reused for all devices after a successful apply.',
  'deviceProxyHost': 'Proxy host',
  'deviceProxyPort': 'Port',
  'deviceProxyApply': 'Apply proxy',
  'deviceProxyClear': 'Clear proxy',
  'deviceProxyNotSet': 'Proxy not set',
  'deviceProxyLoading': 'Reading proxy...',
  'deviceProxyReadFailed': 'Failed to read proxy',
  'deviceProxyInvalid': 'Enter a valid proxy host and a 1-65535 port',
  'deviceProxyApplySuccess': 'Proxy applied',
  'deviceProxyApplyFailed': 'Failed to apply proxy',
  'deviceProxyClearSuccess': 'Proxy cleared',
  'deviceProxyClearFailed': 'Failed to clear proxy',
  ...
  'audioForwardingTooltip': 'Audio forwarding active',
  'start': 'ScreenCast',
  'stop': 'Stop',
  'stopAll': 'Stop all',
